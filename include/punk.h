...
#ifdef WITH_IMAGES
DLLEXPORT void punk_image(const char* img_file, const struct punk_style*);
DLLEXPORT enum punk_click_type punk_image_button(const char* img_file, const struct punk_style*);
#endif
